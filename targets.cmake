...
set(_PATH64_TARGET_FLAGS_mips_32 -target mips32-${system_suffix})
...
set(_PATH64_TARGET_FLAGS_mips_64 -target mips64-${system_suffix})
...
set(_PATH64_TARGET_FLAGS_arm -target arm64-${system_suffix})
...
set(_PATH64_TARGET_FLAGS_aarch64 -target aarch64-${system_suffix})
...
set(_PATH64_TARGET_FLAGS_powerpc64 -target powerpc64-${system_suffix})
...
set(_PATH64_TARGET_FLAGS_powerpc64le -target powerpc64le-${system_suffix})
...
#    set_property(TARGET ${name} PROPERTY ARCHIVE_OUTPUT_DIRECTORY ${build_lib_dir})
    ...
    if(path64_multitarget_property_${name}_${target}_OUTPUT_NAME)
        set(oname ${path64_multitarget_property_${name}_${target}_OUTPUT_NAME})
    elseif(path64_multitarget_property_${name}_OUTPUT_NAME)
